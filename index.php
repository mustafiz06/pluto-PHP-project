...
<head>
    ...
    <title>Pluto - Personal Portfolio HTML5 Template</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="shortcut icon" type="image/x-icon" href="./frontend_assets/./frontend_assets/img/favicon.png">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                        <div class="banner-img text-right">
                            <img src="./frontend_assets/img/banner/banner_img.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
