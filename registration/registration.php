        ...
        <div class="app-auth-container">
            ...
            <form action="./registration_POST.php" method="POST">
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="password" class="form-control <?= (isset($_SESSION['confirm_password error'])) ? 'is-invalid' : ''; ?>" id="signUpPassword" aria-describedby="signUpPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="confirm_password">
                    <?php if (isset($_SESSION['confirm_password error'])) : ?>
                        <div id="emailHelp" class="form-text m-b-md text-danger"><?= $_SESSION['confirm_password error'] ?></div>
                    <?php endif;
                    unset($_SESSION['confirm_password error']) ?>
